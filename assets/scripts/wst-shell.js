(function () {
  ...
  if (headerTarget) {
    headerTarget.outerHTML = [
      ...
      '        <span class="nav-link nav-link--disabled" aria-disabled="true">Production</span>',
      "      </div>",
      '      <div class="nav-item nav-item--disabled">',
      ...
      '        <div class="dropdown">',
      '          <span class="dropdown-link--disabled">Overview</span>',
      '          <span class="dropdown-link--disabled">i-BMS</span>',
      '          <span class="dropdown-link--disabled">n-BMS</span>',
      '          <span class="dropdown-link--disabled">n3-BMS</span>',
      '          <span class="dropdown-link--disabled">c-BMS24x</span>',
      "        </div>",
      "      </div>",
      '      <div class="nav-item">',
