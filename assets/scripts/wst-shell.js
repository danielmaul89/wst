(function () {
  ...
  if (headerTarget) {
    headerTarget.outerHTML = [
      ...
      '          <a href="battery-packs.html">Battery packs</a>',
      "        </div>",
      "      </div>",
      '      <div class="nav-item">',
      '        <a href="development.html" class="nav-link"' + current("development") + '>Development</a>',
      "      </div>",
      '      <div class="nav-item">',
  ...
  if (footerTarget) {
    footerTarget.outerHTML = [
      ...
      '        <li><a href="battery-packs.html">Battery packs</a></li>',
      "      </ul></div>",
