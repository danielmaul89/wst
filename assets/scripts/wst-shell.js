(function () {
  ...
  if (headerTarget) {
    headerTarget.outerHTML = [
      ...
      '      <div class="nav-item">',
      '        <a href="solutions-v7.html" class="nav-link"' + current("solutions") + '>Solutions <svg class="chev" width="10" height="10" viewBox="0 0 10 10" fill="none" aria-hidden="true"><path d="M2 3.5 5 6.5 8 3.5" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/></svg></a>',
      '        <div class="dropdown">',
      '          <a href="solutions-v7.html">Applications</a>',
      '          <a href="product-drone.html">Battery packs / products</a>',
      "        </div>",
      "      </div>",
      '      <div class="nav-item">',
      '        <a href="development.html" class="nav-link"' + current("development") + '>Development <svg class="chev" width="10" height="10" viewBox="0 0 10 10" fill="none" aria-hidden="true"><path d="M2 3.5 5 6.5 8 3.5" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/></svg></a>',
      '        <div class="dropdown">',
      '          <a href="development.html#stage-design">Design &amp; Feasibility Study</a>',
      '          <a href="development.html#stage-prototype">Prototype &amp; Testing</a>',
      '          <a href="development.html#stage-industrialization">Industrialization &amp; Quality Management</a>',
      '          <a href="development.html#stage-compliance">Market Compliance</a>',
      '          <a href="development.html#stage-production">Mass Production &amp; SOP</a>',
      "        </div>",
      "      </div>",
      '      <div class="nav-item">',
      '        <a href="production.html" class="nav-link"' + current("production") + '>Production</a>',
      "      </div>",
      '      <div class="nav-item">',
      '        <a href="bms.html" class="nav-link"' + current("bms") + '>BMS <svg class="chev" width="10" height="10" viewBox="0 0 10 10" fill="none" aria-hidden="true"><path d="M2 3.5 5 6.5 8 3.5" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/></svg></a>',
      '        <div class="dropdown">',
      '          <a href="bms.html#overview">Overview</a>',
      '          <a href="bms.html#i-bms">i-BMS</a>',
      '          <a href="bms.html#n-bms">n-BMS</a>',
      '          <a href="bms.html#n3-bms">n3-BMS</a>',
      '          <a href="bms.html#c-bms24x">c-BMS24x</a>',
      "        </div>",
      "      </div>",
      '      <div class="nav-item">',
  ...
  if (footerTarget) {
    footerTarget.outerHTML = [
      ...
      '        <li><a href="solutions-v7.html">Applications</a></li>',
      '        <li><a href="product-drone.html">Battery packs / products</a></li>',
      "      </ul></div>",
      '      <div class="footer-col"><h4>Development</h4><ul>',
      '        <li><a href="development.html#stage-design">Design &amp; Feasibility Study</a></li>',
      '        <li><a href="development.html#stage-prototype">Prototype &amp; Testing</a></li>',
      '        <li><a href="development.html#stage-industrialization">Industrialization &amp; QM</a></li>',
      '        <li><a href="development.html#stage-compliance">Market Compliance</a></li>',
      '        <li><a href="development.html#stage-production">Mass Production &amp; SOP</a></li>',
      "      </ul></div>",
      '      <div class="footer-col"><h4>Production</h4><ul>',
      '        <li><a href="production.html">Overview</a></li>',
      '        <li><a href="production.html#partner">Manufacturing Partner</a></li>',
      '        <li><a href="production.html#quality">Quality &amp; Traceability</a></li>',
      "      </ul></div>",
  ...
  if (headerTarget && !document.querySelector("[data-wst-product-modal]")) {
    ...
    document.addEventListener("click", function (event) {
      var card = event.target.closest(".cat-card, .app-tile, .show-row, .app-cat-slide");
      if (!card) return;
      event.preventDefault();
