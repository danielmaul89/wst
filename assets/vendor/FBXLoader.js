 ...
 */
	...
	class GeometryParser {
		...
		parseMeshGeometry( relationships, geoNode, deformers ) {
			...
			// Patched for WST: some CAD-exported FBX files have Geometry nodes
			// with no entry in the connections map at all (relationships is
			// undefined), which crashed the stock r128 loader. Treat that as
			// "not associated with any model" instead of throwing.
			if ( ! relationships ) relationships = { parents: [], children: [] };
